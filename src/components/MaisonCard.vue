...
<template>
   ...
   <!--  <div class="personne-card border-2 p-1">
        ...
        <p>Prix : {{ prix }}</p>
        <p>Image: {{ image }}</p>
        <p>Chambres: {{ nbChambres }}</p>
        <p>Salle de bain: {{ nbSdb }}</p>
        <p>Adresse: {{ adresse }}</p>
        <p>Surface: {{ surface }}</p>
        <p>Favori: {{ favori }}</p>
    </div> -->
        ...
        <div
            ...
            <div class="flex justify-center items-center self-stretch flex-grow-0 flex-shrink-0 gap-1.5">
                ...
                <div class="flex justify-center items-center flex-grow relative gap-2">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"
                        class="flex-grow-0 flex-shrink-0 w-5 h-5 relative" preserveAspectRatio="xMidYMid meet">
                        <g clip-path="url(#clip0_34922_473)">
                            <path
                            ...
                            <path d="M3.33325 17.5L4.16659 16.25" stroke="#6366F1" stroke-width="1.66667"
                                stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M16.6666 17.5L15.8333 16.25" stroke="#6366F1" stroke-width="1.66667"
                                stroke-linecap="round" stroke-linejoin="round"></path>
                        </g>
                        <defs>
                            <clipPath id="clip0_34922_473">
                ...
                <div class="flex justify-end items-center flex-grow relative gap-2">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g clip-path="url(#clip0_34922_483)">
                            <path
                            ...
                            <path d="M2 13.1716L6.36371 17.5353" stroke="#6366F1" stroke-width="1.66667"
                                stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M13.6362 17.5353L17.9999 13.1716" stroke="#6366F1" stroke-width="1.66667"
                                stroke-linecap="round" stroke-linejoin="round"></path>
                        </g>
                        <defs>
                            <clipPath id="clip0_34922_483">
                                <rect width="20" height="20" fill="white"></rect>
                            </clipPath>
                        </defs>
                    </svg>
